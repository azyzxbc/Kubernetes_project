...
```
cd existing_repo
git remote add origin https://gitlab.com/devops-internship2/matchnhire.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/devops-internship2/matchnhire/-/settings/integrations)
